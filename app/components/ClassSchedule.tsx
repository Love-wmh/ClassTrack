...
import { mockClassParser } from '~/lib/parsers';
import mockClassData from '~/assets/mockClass.json';
...
export default function ClassSchedule() {
  ...
  useEffect(() => {
    if (classes.length === 0) {
      const parsedClasses = mockClassParser.parse(mockClassData);
      setClasses(parsedClasses);
    }
    initialize();
  }, [classes.length, setClasses, initialize]);
